...
export class PlacesService {
  ...
  fetchPlaces() {
    return this.http.get<{ [key: string]: PlaceData }>('https://ionic-angular-course-1bcb3.firebaseio.com/offered-places.json')
      .pipe(map(resData => {
        const places = [];
  ...
  getPlace(id: string) {
    return this.http.get<PlaceModule>(`https://ionic-angular-course-1bcb3.firebaseio.com/offered-places/${id}.json`)
      .pipe(
        map(placeData => {
  ...
  addPlace(
    ...
    const newPlace = new PlaceModule(
    ...
    return this.http.post<{ name: string }>('https://ionic-angular-course-1bcb3.firebaseio.com/offered-places.json',
      {
        ...newPlace,
        id: null
      })
    ...
    return this.placesData.pipe(
      ...
      switchMap(places => {
        ...
        return this.http.put(
          `https://ionic-angular-course-1bcb3.firebaseio.com/offered-places/${placeId}.json`,
